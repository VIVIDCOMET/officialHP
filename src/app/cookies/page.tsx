      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white/5 rounded-lg p-8">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-purple-100 mb-4">1. Cookieについて</h2>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-purple-100 mb-4">2. 使用目的</h2>
            <p className="text-white leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-purple-100 mb-4">3. 使用するCookieの種類</h2>
            <div className="space-y-4">
              <div>
                <h3 className="text-xl font-semibold text-purple-200 mb-2">必須Cookie</h3>
                <p className="text-white leading-relaxed">
                  ウェブサイトの基本的な機能を提供するために必要不可欠なCookieです。これらは無効にすることはできません。
                </p>
              </div>
              <div>
                <h3 className="text-xl font-semibold text-purple-200 mb-2">パフォーマンスCookie</h3>
                <p className="text-white leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-purple-100 mb-4">4. Cookieの管理</h2>
            <p className="text-white leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-purple-100 mb-4">5. 個人情報の取り扱い</h2>
            <p className="text-white leading-relaxed">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-bold text-purple-100 mb-4">6. ポリシーの更新</h2>
            <p className="text-white leading-relaxed">
          ...
          <div className="text-purple-200 text-sm">最終更新日: 2025年5月27日</div>
        </div>
      </div>
    </main>
  );
